...
#define WHITE   0x7FFF
// Extra Colors
#define LIGHTPINK    RGB(31, 16, 20)
#define PINK    RGB(30, 8, 15)
#define HOTPINK    RGB(24, 4, 10)
#define DARKRED    RGB(25, 0, 0)
#define CORAL    RGB(31, 14, 15)
#define DARKBLUE    RGB(5, 16, 28)
